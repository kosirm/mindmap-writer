...
// Current orientation
export let currentOrientation: Orientation = 'right-left'
emitter.on('orientation', (value: Orientation) => currentOrientation = value || currentOrientation)
...
emitter.on('edit-flag', (val: boolean) => editFlag = !!val)
...
emitter.on('mindmap-context', (val: SetupContext) => val ? mmcontext = val : null)
